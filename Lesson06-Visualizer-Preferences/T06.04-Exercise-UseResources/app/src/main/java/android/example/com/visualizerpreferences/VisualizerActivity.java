...
public class VisualizerActivity extends AppCompatActivity {
    ...
    private void setupSharedPreferences() {
        ...
        boolean fBassDefault = getResources().getBoolean(R.bool.pref_show_bass_default);
        mVisualizerView.setShowBass(sharedPreferences.getBoolean("show_bass", fBassDefault));
