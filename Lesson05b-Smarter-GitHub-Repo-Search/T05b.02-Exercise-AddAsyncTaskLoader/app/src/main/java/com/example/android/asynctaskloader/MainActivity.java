...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<String>
{
    ...
    private void makeGithubSearchQuery() {
        ...
        // this is different from the traditional loader flow,
        // we execute after user hits the query button rather than when activity created
        //
    ...
    //bundle set to final so we can access them from our inner class function
    @Override
