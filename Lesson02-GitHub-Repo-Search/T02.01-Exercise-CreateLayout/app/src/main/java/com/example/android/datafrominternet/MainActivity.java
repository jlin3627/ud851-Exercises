...
public class MainActivity extends AppCompatActivity {
    ...
    // DONE Create an EditText variable called mSearchBoxEditText
    private EditText mSearchBoxEditText;
    // DONE Create a TextView variable called mUrlDisplayTextView
    private TextView mUrlDisplayTextView;
    // DONE Create a TextView variable called mSearchResultsTextView
